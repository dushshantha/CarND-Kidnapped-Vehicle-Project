...
void ParticleFilter::init(double x, double y, double theta, double std[]) {
    ...
    normal_distribution<double> x_init_nd(0, std[0]);
    normal_distribution<double> y_init_nd(0, std[1]);
    normal_distribution<double> theta_init_nd(0, std[2]);
